--- a/lib/widgets/custom_search_view.dart
+++ b/lib/widgets/custom_search_view.dart
@@
...
+              ),
+            ),
+        prefixIconConstraints: prefixConstraints ?? BoxConstraints(maxHeight: 40.h),
+        suffixIcon:
+        suffix ??
+            Padding(
...
+              ),
+            ),
+        suffixIconConstraints: suffixConstraints ?? BoxConstraints(maxHeight: 40.h),
+        isDense: true,
