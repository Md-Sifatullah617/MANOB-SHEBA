...
import '../presentation/reset_password_email_screen/binding/reset_password_email_binding.dart';
import '../presentation/reset_password_email_screen/reset_password_email_screen.dart';
...
class AppRoutes {
  ...
  static List<GetPage> pages = [
    ...
    GetPage(
      ...
      bindings: [OnboardingFourBinding()],
    ),
    GetPage(
      name: loginScreen,
      page: () => LoginScreen(),
    ...
    GetPage(
      ...
      bindings: [ResetPasswordEmailBinding()],
    ),
    GetPage(
      name: resetPasswordVerifyCodeScreen,
      page: () => ResetPasswordVerifyCodeScreen(),
      bindings: [ResetPasswordVerifyCodeBinding()],
    ),
    GetPage(
      name: createNewPasswordScreen,
      page: () => CreateNewPasswordScreen(),
      bindings: [CreateNewPasswordBinding()],
    ),
    GetPage(
      name: homeScreen,
      page: () => HomeScreen(),
    ...
    GetPage(
      ...
      bindings: [DrugsDetailBinding()],
    ),
    GetPage(
      name: myCartScreen,
      page: () => MyCartScreen(),
      bindings: [MyCartBinding()],
    ),
    GetPage(
      name: locationScreen,
      page: () => LocationScreen(),
